...
drawColour:		.word 0x00FF0000		# Store colour to draw objects
bgColour:		.word 0xFF000000		# Store colour to draw background
...
CoordsToAddress:
		...
		li $a0, 16		 # Load the screen width into a0
...
# Returns none
FillMemory:
		li $a1, 16		# Calculate ending possition
		li $a2, 16
...
AddBoundaries_t:	
		...
		li $a1, 16		# Calculate next ending condition
		li $a2, 16
		multu $a1, $a2			# Multiply screen width by screen height
		nop
		mflo $a2			# Retreive total tiles
...
AddBoundaries_s:	
		...
		li $a1, 16		# Calculate final ending possition
		li $a2, 16
		multu $a1, $a2			# Multiply screen width by screen height
		nop
		mflo $a2			# Retreive total tiles
